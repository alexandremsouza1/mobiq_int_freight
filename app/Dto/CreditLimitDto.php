...
class CreditLimitDto
{
    ...
    public function __construct(array $data)
    {
        ...
        $this->visitDate = $data['DataVisita'] ?? null;
        $this->channelDescription = $data['DescCanal'] ?? null;
        $this->subchannelDescription = $data['DescSubcanal'] ?? null;
        $this->available = $data['Disponivel'] ?? null;
        $this->edi = $data['EDI'] ?? null;
        $this->deliveryD = $data['EntregaD'] ?? null;
        $this->deliveryOption1 = $data['EntregaOpcao1'] ?? null;
        $this->deliveryOption2 = $data['EntregaOpcao2'] ?? null;
        $this->financialStatement = $data['FichaFinanceira'] ?? null;
        $this->phone1 = $data['Fone1'] ?? null;
        $this->phone1Vendor = $data['Fone1Vendedor'] ?? null;
        $this->phone1VendorPlanner = $data['Fone1VendedorPlanner'] ?? null;
        $this->phone2 = $data['Fone2'] ?? null;
        $this->phone2Vendor = $data['Fone2Vendedor'] ?? null;
        $this->phone2VendorPlanner = $data['Fone2VendedorPlanner'] ?? null;
        $this->cutoffTime = $data['HorarioCorte'] ?? null;
        ...
        $this->minimumOrder = $data['PedidoMinimo'] ?? null;
        $this->partners = $data['Socios'] ?? [];
        $this->subchannel = $data['Subcanal'] ?? null;
        $this->spentValue = $data['ValorGasto'] ?? null;
        $this->salesman = $data['Vendedor'] ?? null;
        $this->salesmanPlanner = $data['VendedorPlanner'] ?? null;
        $this->visit = $data['Visita'] ?? null;
        $this->visitKonnect = $data['VisitaKonnect'] ?? null;
        $this->visitSales = $data['VisitaVendas'] ?? null;
        $this->visitPlanner = $data['VisitaPlanner'] ?? null;
    }
